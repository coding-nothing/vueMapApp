...
onMounted(() => {
    ...
    map.initMapListener('click', (event: any) => {
        ...
        useMarkerPopRef.value && map.addOverlay(markerInfoApp.value, event.coordinate as Lnglat)
...
<template>
    <div class="map-container">
        ...
        <div v-if="useMarkerPopRef" ref="markerInfoApp" style="padding: 20px;border-radius: 15px;background-color: rgba(150, 150, 150, 0.7);">
